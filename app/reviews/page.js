...
export const metadata = { title: "Past reviews · Alyeska" };

// This address is where reviews lived originally, and for a while it was a
// redirect to Preferences, which had swallowed them. They are a screen again:
// what the family thought of a hotel is a different question from how they like
// to travel, and the two halves were only ever on one page because they were
// written in the same week.
//
