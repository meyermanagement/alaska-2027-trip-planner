 ...
 *
 * Shared by the People tab button and by Aly's `invite_person`, so both say the
...
export async function sendTravelerInvite({
  ...
  const selfTest = !!traveler.user_id && traveler.user_id === inviterId;
