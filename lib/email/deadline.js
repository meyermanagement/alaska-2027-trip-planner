...
export function deadlineEmail({ name, email, siteUrl, alerts = [] }) {
  ...
  const text = [
    ...
    "",
    "Nothing here was found by us. Every date came off something your family put in — a fare somebody pasted, an offer somebody recorded.",
    "",
    "— Alyeska",
  ].join("\n");
...
<div style="font-family:${SANS}; font-size:14px; line-height:1.55; color:${INK};">Nothing here was found by us. Every date came off something your family put in &mdash; a fare somebody pasted in, an offer somebody recorded &mdash; so the price and the deadline are whoever's you got them from.</div>
</td>
</tr>
</table>
