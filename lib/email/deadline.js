...
Sent to ${escapeHtml(email)} because nobody in the household has turned on notifications yet. Turn them on from the <a href="${escapeHtml(siteUrl)}/now" style="color:${TEAL}; text-decoration:underline;">Now screen</a> and these arrive on your phone instead.<br>
