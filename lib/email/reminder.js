...
const INK = "#241f18";
const INK_SOFT = "#6e6555";
const SAND = "#f6f1e6";
const SAND_DEEP = "#f0e9d9";
const TEAL = "#1b5a4c";
const TEAL_SOFT = "#dce9e2";
const ROSE = "#96334c";
const AMBER = "#8f5416";
...
<!-- card -->
<tr>
<td style="background:#fffdf8; border:1px solid ${SAND_DEEP}; border-radius:16px; padding:32px 28px;">
