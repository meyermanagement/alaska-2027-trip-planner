...
const INK = "#241f18";
const INK_SOFT = "#665e4d";
const SAND = "#f1e9d8";
const SAND_DEEP = "#ddd0b4";
const TEAL = "#1b5a4c";
const TEAL_SOFT = "#d9e6de";
const ROSE = "#96334c";
const AMBER = "#8f5416";
...
<!-- card -->
<tr>
<td style="background:#fdfaf0; border:1px solid ${SAND_DEEP}; border-radius:16px; padding:32px 28px;">
