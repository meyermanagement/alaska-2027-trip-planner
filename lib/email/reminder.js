...
<!-- wordmark: the compass mark, then the name. The image is a 128px PNG
     served from the deployment rather than inline SVG, because Gmail and
     Outlook both strip SVG; its alt text is the word "Alyeska" so the header
     still reads as itself with images turned off, which is the state most
     inboxes start in. -->
<tr>
...
<div style="font-family:${SANS}; font-size:12px; font-weight:500; letter-spacing:-0.005em; color:${INK_SOFT}; padding-top:6px;">Travel, Personalized. Contextualized. Simplified.</div>
</td>
</tr>
