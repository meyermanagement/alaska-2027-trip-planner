 ...
 *
 * The opening deliberately shares no examples with the Meet Aly screen, which is
 * the next thing these people read. Both make the same argument, so the
 ...
 *
 * It says them in three short paragraphs, which is the middle of two failures.
 * The first draft argued for three long ones, and a long paragraph in an inbox is
 * read at a glance or not at all. Cutting them to five marked lines fixed the
 * length and broke the voice: a list of scenes is a brochure, and this message is
 * the one place Aly is speaking to somebody before she knows anything about them.
 * So the moments stay whole and joined up, in her sentences, and what went is the
 * scaffolding between them rather than the warmth.
 *
 ...
 * an unfound button collects nothing.
 */
...
export function betaInviteEmail({ name, email, code, siteUrl, note }) {
  ...
  const text = [
    ...
    "",
    "I am the one who does the planning here. Tell me you have a free week in June, who is coming and what you can spend, and instead of fourteen tabs over three evenings you get days you can argue with, and a word from me when one night starts costing too much. Your programs live in one place too, so a room can come out of points you had forgotten you had.",
    "",
    "I look after the parts nobody wants to be in charge of: the suitcase list, written before you think of it and down to the inhaler, and the date inside a document, read while there is still time to do something about it. And at half past five, everybody hungry on a street you do not know, I answer that instead of handing you a search box.",
    "",
    "You are one of the first families I get to do this for, which is the exciting part, and also means you will find corners I have not finished.",
    "",
    `Your code: ${code}`,
    "",
    `Open it here: ${openUrl}`,
    "",
    "It opens a household of your own. I will ask a few questions about how you travel, then take a trip you are actually thinking about \u2014 real, or still half an idea \u2014 and show you what I do with it.",
    "",
    note ? `From Mark: ${note}` : null,
    note ? "" : null,
    "If something is wrong, slow or plainly annoying, tell me. I would far rather hear it now than have you be polite about it. There is a small flag, a rose one, in the bottom left corner of every screen, and it is only there for you: tap it, say what happened, and add a screenshot if you have one.",
    "",
    "\u2014 Aly, at Alyeska",
  ]
...
I am the one who does the planning here. Tell me you have a free week in June, who is coming and what you can spend, and instead of fourteen tabs over three evenings you get days you can argue with &mdash; and a word from me when one night starts costing too much. Your programs live in one place too, so a room can come out of points you had forgotten you had.
</p>
...
You are one of the first families I get to do this for. That is the exciting part, and it also means you will find corners I have not finished.
</p>
...
It opens a household of your own. I will ask a few questions about how you travel, then take a trip you are actually thinking about &mdash; real, or still half an idea &mdash; and show you what I do with it.
</p>
...
<div style="font-family:${SANS}; font-size:15px; line-height:1.6; color:${INK};">If something is wrong, slow or plainly annoying, tell me. I would far rather hear it now than have you be polite about it.</div>
...
<!-- The flag itself, as a 28px PNG at three times the size, because the button
     it points at is an icon with no label: a picture of the thing is worth more
     here than another sentence describing a corner. PNG rather than the inline
     SVG the app draws, for the same reason the wordmark is a PNG. -->
...
<td valign="top" style="font-family:${SANS}; font-size:15px; line-height:1.6; color:${INK_SOFT};">This is what to look for, in the bottom left corner of every screen. It is only there for you: tap it, say what happened, and add a screenshot if you have one.</td>
</tr>
</table>
</td>
</tr>
