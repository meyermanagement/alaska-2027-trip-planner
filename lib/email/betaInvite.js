 ...
 *
 * The body keeps three conversational paragraphs rather than a feature list.
 * This is the shorter Option B selected for the invitation; the issue-reporting
 * instructions and flag image remain independent of the opening copy.
 */
...
export function betaInviteEmail({ name, email, code, siteUrl, note }) {
  ...
  const text = [
    `Hi ${first}, I’m Aly.`,
    "",
    "Your personal travel assistant…advisor…concierge…planner… well, let’s just say Wherever you’re headed, I’ve got your back.",
    "",
    "You don’t need to have the trip figured out before we talk. A free week in June, who’s coming and a rough budget are plenty to get us started. I’ll get to know how you like to travel, then put together days that fit you and are easy to change. I’ll keep your budget in view and tell you which night is driving up the total. I’ll also keep your airline, hotel and card programs together, so we can put forgotten points and year-end credits to work.",
    "",
    "The little things matter just as much. If six is too early for one of you or somebody needs an inhaler, I’ll account for that in the day’s pace and packing list. I’ll check entry requirements and document dates before they become last-minute problems. And when everybody’s hungry at half past five somewhere unfamiliar, you can ask me where to eat rather than start another search.",
    "",
    "Wherever you’re headed, I’ve got your back.",
    "",
...
Your personal travel assistant…advisor…concierge…planner… well, let’s just say <strong style="font-weight:700; color:${INK};">Wherever you’re headed, I’ve got your back.</strong>
</p>
...
<strong style="font-weight:700;">Wherever you’re headed, I’ve got your back.</strong>
</p>
