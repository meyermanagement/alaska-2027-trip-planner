...
<img src="${escapeHtml(siteUrl)}/beta-survey-menu.png" width="420" height="357" alt="The menu, with the More drawer open and the row named Beta Survey ringed" style="display:block; width:100%; max-width:420px; height:auto; border:0; outline:none; text-decoration:none; border-radius:8px;">
</td>
</tr>
</table>
</td>
