...
export function betaInviteEmail({ name, email, code, siteUrl, note }) {
  ...
  const text = [
    `Hi ${first}, I’m Aly. Let’s talk about your next trip.`,
    "",
...
<h1 style="margin:8px 0 0; font-family:${DISPLAY}; font-size:26px; line-height:1.25; font-weight:600; letter-spacing:-0.012em; color:${INK};">Hi ${escapeHtml(first)}, I’m Aly.<br>Let’s talk about your next trip.</h1>
