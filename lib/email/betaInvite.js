...
export function betaInviteEmail({ name, email, code, siteUrl, note }) {
  ...
  const text = [
    ...
    "",
    "I look after the boring half of traveling, and the stressful half too. Say Alaska in August and I hand back an ordered draft, priced to what you want to stay under. Your points and card credits sit in one wallet, so a hotel can read as 30,000 points instead of $340. I build the packing list from who is going and the real forecast, watch passport dates and entry rules, email what is due each morning, and while you are there I answer what is next and what is near you, picked for your family rather than a stranger. One plan everybody reads, and I speak up before a date turns into a problem. You are one of the first families I get to do that for.",
    "",
    `Your code: ${code}`,
    "",
    ...
    note ? "" : null,
    "If something is wrong, slow or plainly annoying, say so. That is what this round is for. There is a small flag in the bottom left corner of every screen, and it is only there for you: tap it, tell me what happened, and add a screenshot if you have one.",
    "",
    "— Aly, at Alyeska",
  ]
...
I look after the boring half of traveling, and the stressful half too. Say Alaska in August and I hand back an ordered draft, priced to what you want to stay under. Your points and card credits sit in one wallet, so a hotel can read as 30,000 points instead of $340. I build the packing list from who is going and the real forecast, watch passport dates and entry rules, email what is due each morning, and while you are there I answer what is next and what is near you &mdash; picked for your family, not a stranger. One plan everybody reads, and I speak up before a date turns into a problem. You are one of the first families I get to do that for.
</p>
