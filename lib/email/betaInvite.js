...
export function betaInviteEmail({ name, email, code, siteUrl, note }) {
  ...
  const text = [
    ...
    "",
    "Tell me you have a free week in June, who’s coming and what you’d like to spend. We can start there instead of spending three evenings with fourteen tabs open. I’ll get to know how you like to travel, then put together days that fit you and are easy to change. I’ll keep your budget in view and tell you which night is driving up the total. I’ll also keep your airline, hotel and card programs together, so we can put forgotten points and year-end credits to work.",
    "",
