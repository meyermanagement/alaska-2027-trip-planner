...
export function betaInviteEmail({ name, email, code, siteUrl, note }) {
  ...
  const text = [
    ...
    "",
    "I know one of you cannot start at six and somebody needs an inhaler, so the packing list is written before you think of it and the day is paced for the slowest walker. I read the small print of a border, and the date inside a document, while there is still time to do something about either. And when you are standing on a street at half past five with everybody hungry, I answer that, rather than handing you a search box. You are one of the first families I get to do any of this for.",
    "",
    `Your code: ${code}`,
    "",
