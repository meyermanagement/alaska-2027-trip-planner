 ...
 *
 * It says them as pictures rather than paragraphs. The argument used to run three
 * paragraphs deep, and a paragraph in an inbox is read at a glance or not at all:
 * every clause that explains the moment instead of showing it is a clause nobody
 * reaches. So the middle of the message is five short scenes, one line each,
 * marked down the left, and everything that was scaffolding between them is gone.
 * A reader who only sees the shapes still gets the offer.
 *
...
export function betaInviteEmail({ name, email, code, siteUrl, note }) {
  ...
  const text = [
    ...
    "",
    "Fourteen tabs, three evenings, still no plan. Tell me instead: a free week in June, who is coming, what you can spend.",
    "",
    "Days you can argue with, instead of a blank page.",
    "A ceiling I plan under, and a word when a night costs too much.",
    "A room paid out of points you had forgotten you had.",
    "A suitcase list written before you think of it, down to the inhaler.",
    "Half past five, everybody hungry, an answer instead of a search box.",
    "",
    `Your code: ${code}`,
    "",
    `Open it here: ${openUrl}`,
    "",
    "The code opens a household of your own. I will ask a few questions about how you travel, then take a trip you are actually thinking about \u2014 real or half an idea \u2014 and show you what I do with it.",
    "",
    note ? `From Mark: ${note}` : null,
    note ? "" : null,
    "You are one of the first families, so you will find corners I have not finished. Tell me when you do: there is a small flag in the bottom left corner of every screen, only there for you.",
    "",
    "\u2014 Aly, at Alyeska",
  ]
...
<!-- The five scenes. A row each, a teal tick down the left, and no sentence
     long enough to need a second glance. Squares rather than round dots because
     Outlook still ignores border-radius on a div. -->
...
${[
  ...
  .map(
    (line) => `<tr>
<td width="18" valign="top" style="padding:0 0 10px;"><div style="width:5px; height:5px; margin:8px 0 0; background:${TEAL}; font-size:0; line-height:0;">&nbsp;</div></td>
<td valign="top" style="padding:0 0 10px; font-family:${SANS}; font-size:16px; line-height:1.5; color:${INK};">${line}</td>
</tr>`,
  )
  .join("\n")}
</table>
...
The code opens a household of your own. I will ask a few questions about how you travel, then take a trip you are actually thinking about &mdash; real, or half an idea &mdash; and show you what I do with it.
</p>
...
<div style="font-family:${SANS}; font-size:15px; line-height:1.6; color:${INK};">You are one of the first families, so you will find corners I have not finished. Tell me when you do, rather than being polite about it.</div>
<div style="font-family:${SANS}; font-size:15px; line-height:1.6; color:${INK_SOFT}; padding-top:8px;">Small flag, bottom left corner of every screen, only there for you. Tap it, say what happened, add a screenshot if you have one.</div>
</td>
</tr>
</table>
