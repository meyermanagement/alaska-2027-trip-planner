 ...
 * cell as Alyeska and TRAVEL, on the line under TRAVEL, rather than centered
...
export function wordmarkRow({ siteUrl, tagline }) {
  const taglineBlock = tagline
    ? `
<div style="font-family:${SANS}; font-size:12px; line-height:1.35; font-weight:500; letter-spacing:-0.005em; color:${INK_SOFT}; padding-top:7px;">${escapeHtml(tagline)}</div>`
    : "";
...
<div style="font-family:${SANS}; font-size:10px; line-height:1.1; font-weight:700; letter-spacing:0.19em; color:${TEAL}; padding-top:5px;">TRAVEL</div>${taglineBlock}
</td>
</tr>
</table>
</td>
