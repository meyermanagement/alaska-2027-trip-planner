 ...
 * letterspaced capitals with a hairline under ALY, the same lockup the loading
 ...
 * The rule is the lower border of the ALY span, so its width follows the letters
 * instead of assuming the font will render the same number of pixels everywhere.
...
<div aria-label="Alyeska" style="font-family:${DISPLAY}; font-size:21px; line-height:1; font-weight:600; letter-spacing:0.26em; color:${TEAL}; white-space:nowrap;"><span style="display:inline-block; padding-bottom:6px; border-bottom:1px solid #9bc9c3;">AL<span style="letter-spacing:0;">Y</span></span><span style="display:inline-block; padding-left:0.26em;">ESKA</span></div>${captionBlock}
</td>
</tr>
</table>
</td>
