 ...
 * cell as the wordmark, on the line under its rule, rather than centered
 ...
 * screens, the sign-in screen and the desktop menu carry. It replaces a
 * mixed-case Alyeska with the word TRAVEL under it. The rule does what that
 * second line was doing -- closing the lockup off underneath -- without a second
 * word to read, and letterspaced capitals do not need a caption to look like a
 * mark. The rule is a one-pixel div with a zero font size and a non-breaking
...
export function wordmarkRow({ siteUrl, tagline }) {
  const taglineBlock = tagline
    ? `
<div style="font-family:${SANS}; font-size:12px; line-height:1.35; font-weight:500; letter-spacing:-0.005em; color:${INK_SOFT}; padding-top:9px;">${escapeHtml(tagline)}</div>`
    : "";
...
<div style="width:38px; height:1px; line-height:1px; font-size:0; background:#9bc9c3; margin-top:6px;">&nbsp;</div>${taglineBlock}
</td>
</tr>
</table>
</td>
