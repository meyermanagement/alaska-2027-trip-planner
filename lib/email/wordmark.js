 ...
 * cell as the wordmark, on the line under Travel, rather than centered
 ...
 * line under the rule, exactly as the long opening sets it: the rule closes the
 * name off and the second word says what the company is, which are two different
 * jobs and were being done by one line before. It is mixed case here rather than
 * the small capitals it used to be, because capitals under letterspaced capitals
 * read as a second wordmark competing with the first.
...
export function wordmarkRow({ siteUrl, tagline }) {
  const taglineBlock = tagline
    ? `
<div style="font-family:${SANS}; font-size:12px; line-height:1.35; font-weight:500; letter-spacing:-0.005em; color:${INK_SOFT}; padding-top:5px;">${escapeHtml(tagline)}</div>`
    : "";
...
<div style="width:38px; height:1px; line-height:1px; font-size:0; background:#9bc9c3; margin-top:6px;">&nbsp;</div>
<div style="font-family:${SANS}; font-size:14px; line-height:1.2; font-weight:500; letter-spacing:0.01em; color:${INK_SOFT}; padding-top:6px;">Travel</div>${taglineBlock}
</td>
</tr>
</table>
</td>
