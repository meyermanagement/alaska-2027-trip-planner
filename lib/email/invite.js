 ...
 * the serif-over-sans pairing are lifted straight from globals.css so the
 * message and the site read as one thing. Gmail strips <style> blocks in some
 * views and Outlook ignores most of CSS, and every rule here survives both.
 */
...
export function inviteEmail({
  ...
  const subject = `${inviterName} added you to the ${familyName} trip planner`;
  ...
  const text = [
    `${inviterName} added you to the ${familyName} trip planner on Alyeska.`,
    "",
...
${escapeHtml(inviterName)} added you to the ${escapeHtml(familyName)} trip planner. It holds the itineraries, packing lists, and pre-trip checklists for every trip we have coming up &mdash; and you can change any of it.
</p>
