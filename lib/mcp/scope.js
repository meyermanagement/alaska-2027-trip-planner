...
// reads beta_consents), and the MCP-specific redactions -- no health, allergy or
// mobility data, no confirmation, ID, member, policy or microchip numbers, no
// typed notes, nothing that names a child (see touchesMinor in
// householdTools.js), no cross-household
