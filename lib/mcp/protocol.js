...
const INSTRUCTIONS =
  "Access to one household's saved travel in Alyeska: trips, one itinerary day at a time with booking advice, packing and day packs, reminders, adult travelers, preferences, budget, wallet balances and card offers, document and pet expiration dates, insurance coverage, deadlines, trip essentials, pro tips, nearby tips, bucket list, fare alerts, pets, favorite moments and past reviews. The only change it can make is checking a packing item off, or back on; if more than one item matches, ask the person which. A parent also sees their children's packing and day pack items; nothing else about a child is shared. Health and allergy details, typed notes, and confirmation, ID, member, policy and microchip numbers are not shared. Some tools are for the household's primary travelers only.";
