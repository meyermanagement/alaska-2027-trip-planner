...
// database.
export async function handleMessage(message, { headers = {}, client, getScope, confirmSecret, clientId, log = () => {} }) {
  ...
  switch (method) {
    ...
    case "tools/list":
      return { status: 200, body: reply(id, { tools: LISTED_TOOLS, ttlMs: 3600000 }) };
    case "tools/call": {
      ...
      try {
        ...
        const result = await callTool(client, scope, name, args && typeof args === "object" && !Array.isArray(args) ? rest : args);
