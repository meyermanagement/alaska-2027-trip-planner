...
// start with this prefix followed by at least one more character.
export const TRUSTED_ASSISTANTS = [
  ...
  },
  {
    ...
    // One address per person and connection, under this path. Seen in a
    // third-party developer forum, not in Google's documentation; confirm
    // against the first real Gemini registration before relying on it.
    redirects: [{ prefix: "https://oauth-redirect.googleusercontent.com/r/" }],
  },
