...
// a household. Six tools write, and none of them deletes, edits a line's words,
// or touches the itinerary, money or preferences: check_off_packing_item here,
// and in writeTools.js check_off_day_pack_item, complete_reminder,
// add_packing_item, add_reminder and add_bucket_list_place. Each runs through
// the signed-in person's own client, so row-level security and the secondary
// check-off guards decide what it may touch -- the same rules the app's own
// checkboxes and forms run under. Adding is for primary travelers only.
//
