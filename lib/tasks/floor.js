    ...
    rows: () => [
      {
        ...
        detail:
          "The app cannot tell yet whether any part of this trip crosses a border, and until it knows it will not put a passport on the packing list, work out what money to get, or say anything about roaming. Press Look for tips on this trip to have it researched, and check the answer yourself if the itinerary is still thin.",
        timing: "before_trip",
        priority: "high",
        assignee: "Shared",
      },
      ...
      return [
        {
          ...
          detail:
            "The trip is known to leave the country, but not which money it needs. Some places take dollars happily and some do not, and the answer changes what you order from the bank. Press Look for tips on this trip and the app will research it.",
          timing: "before_trip",
          priority: "normal",
          assignee: "Shared",
        },
