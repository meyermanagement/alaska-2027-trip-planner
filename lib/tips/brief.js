...
export function tipBrief({
  ...
  lines.push("");
  lines.push(
    "THEIR LOYALTY STANDINGS — which programs they belong to and at what level. A level that moves a booking date moves it for them:",
  );
  lines.push(...memberLines(memberships, travelers));
  lines.push("");
