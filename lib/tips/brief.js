...
{"tips":[{"title":"…","body":"…","because":"…","urgency":"now|soon|whenever","act_by":"YYYY-MM-DD or null","for_date":"YYYY-MM-DD or null","carry_item":"… or null"}]}
  ...
  for_date the one day of this trip a thing is carried, worn, or left behind, when that is what the tip is about — binoculars for the whale-watching morning, a printed license for the park entrance, closed shoes for a lava field. It must be a day on the itinerary below. Null for everything else, which is most tips: advice about booking, timing, ordering, asking, or what to put in the suitcase is not a day-carry tip, and neither is clothing for a whole cruise.

  carry_item only when for_date is set, and only when the tip is about a thing to put in the bag or on a person that day: the object itself as a short noun phrase, under 60 characters, no verb and no sentence — "10L dry bag", "printed fishing license", "closed-toe shoes". Null whenever the advice is about the day rather than a thing in the bag: taking less, leaving something behind, a weight limit, when to set off, what the crew will hand you. A day tip with a null carry_item is still worth having; it is shown as something to know rather than something to tick.
