...
export const PLEDGE_PROMISES = [
  ...
  },
  {
    ...
    body: "No banner ads, no sponsored suggestions, no highlighted results in exchange for a fee, no partner tiles that look like recommendations. No commission on anything you book, either. The app makes its money the same way a family does, from the people using it, so it does not have to make it any other way. If a supplier gets mentioned, it is because Aly thinks it is the right answer for the family asking.",
  },
];
