...
export const PLEDGE_INTRO =
  "Five promises that decide how the app is built. Not marketing lines. The first three are about you: the reason Alyeska answers the way it does, and the reason the app stays out of your inbox and off your data. The last two are about how the company behind it runs.";

export const PLEDGE_PROMISES = [
  {
    title: "No bias",
    body: "Alyeska does not have preferred hotels, preferred airlines, or preferred anything. When it suggests a place to stay, a restaurant to try, or a route to take, it is choosing on what fits the family in front of it: your preferences, your past reviews, your travelers' ages and pace. Not what a supplier paid it to say. It will disagree with a popular pick when it is wrong for you, and it will point you at an unknown one when it is right.",
  },
  {
  ...
  },
  {
    ...
    body: "No banner ads, no sponsored suggestions, no highlighted results in exchange for a fee, no partner tiles that look like recommendations. No commission on anything you book, either. The app makes its money the same way a family does, from the people using it, so it does not have to make it any other way. If a supplier gets mentioned, it is because Alyeska thinks it is the right answer for the family asking.",
  },
];
...
export const PLEDGE_COMPANY_PARTS = [
  {
    title: "How Alyeska uses AI",
    lead: "You stay in control of the AI, and of what it knows about you.",
    points: [
      "It says when it is unsure instead of guessing at you.",
      "Household, work, and group travel stay separate unless you tell it to cross between them.",
      "Changes to your plans are proposed for you to accept, never made quietly.",
      "You can correct what it knows, report an answer that was wrong, take a copy, or delete it.",
  ...
  },
  {
    ...
    points: [
      ...
      "The giving never changes what Alyeska recommends.",
