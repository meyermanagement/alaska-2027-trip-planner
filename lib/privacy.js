...
export const PROCESSORS = [
  ...
  {
    name: "Resend",
    role: "Sending reminders and account email",
...
export const AI_SECTION = {
  ...
  points: [
    ...
    "What is sent with a question about a trip: the travelers on it and their ages, dietary and accessibility notes, dates, destinations, bookings, and whether a document or policy needs attention.",
    "What is never sent: your passwords, passport and document numbers, policy numbers, payment card details, and anything belonging to another household.",
...
export const PRIVACY_SECTIONS = [
  ...
  },
  {
    ...
    points: [
      ...
      "Original forwarded email messages: 30 days, then discarded. The booking read out of one stays with the trip.",
  ...
  },
  {
    id: "children",
    heading: "Children",
    body: "The app is not for children to sign up to, and an account requires you to be 18 or older. A parent may add a child as a traveler in their household, with a name, an age, and preferences, so that plans and packing fit the family actually going. That information is entered by the adult, is visible only inside their household, is never sent to an advertiser, and is never used to build a profile of the child. Ask us to remove it and we will.",
  },
  {
    id: "transfers",
