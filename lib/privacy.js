...
export const PROCESSORS = [
  ...
  },
  {
    ...
    role: "Web lookups, reading documents and forwarded email, tips, and generated trip images",
    sends:
...
export const AI_SECTION = {
  ...
  body: `Aly is not a person and not our own model. When you ask her something, your question and the parts of your trip needed to answer it are sent to the ${ASSISTANT_PROVIDER}. Everything else goes to the ${READER_PROVIDER}, including questions that need the web, documents you ask her to read, forwarded confirmations, and tips, processed on servers in the United States. If OpenAI is unavailable, an answer may come from Google instead. These are the only model providers we send to; if that ever changes we will name the new one here and ask you again before anything reaches it. This is the one place your household's information leaves our own systems for a purpose other than storing or delivering it, so it is a choice you make rather than a default you discover.`,
  points: [
