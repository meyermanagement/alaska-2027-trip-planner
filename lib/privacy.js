...
export const AI_SECTION = {
  ...
  points: [
    ...
    "Your passwords, your uploaded document files, and anything belonging to another household are never sent.",
  ],
};
