...
import { destinationAwardFares, programAwardFares } from "./destination-awards";
...
export function newsletterFares(text, airports = []) {
  ...
  const programAwards = programAwardFares(clean, airports, context.destinations);
  if (programAwards.recognized) return programAwards;
