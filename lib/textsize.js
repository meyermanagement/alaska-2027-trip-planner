 ...
 *
 * The steps are small on purpose, and the ladder itself now starts a step up
 * from where it first shipped: Regular is the size the app opens at, and body
 * text on a phone runs about 17 pixels there, 19 at Large and 20 at Largest.
 * Going further than the top step starts breaking rows that hold a time, a
 * title and a pill on one line, and the honest answer for somebody who needs
 * more than this is the browser's or the operating system's own zoom, which
 * reflows everything rather than only the text.
 *
...
export const TEXT_SIZES = [
  {
    id: "regular",
    name: "Regular",
    note: "The size the app opens at.",
  },
  {
    id: "large",
    name: "Large",
