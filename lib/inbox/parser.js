...
If kind is "insurance", fill the insurance object and leave items empty. A travel insurance confirmation names an insurer or a plan and says what happens if the trip is cancelled, cut short, or somebody is hurt or has to be flown home. Everyday health insurance — an employer plan, a Medicare notice, an explanation of benefits from a doctor at home — is not this, and is "not_booking".

The insurance object:
- provider: the insurer or the brand that sold the plan, as printed. e.g. "Allianz Travel", "GeoBlue", "Travel Guard".
...
export function normalizePolicy(raw) {
  ...
  return {
    ...
    kind: start && end && daysBetween(start, end) > 300 ? "annual" : "trip",
    provider,
