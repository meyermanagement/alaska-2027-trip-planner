...
export const TIP_CASES = [
  ...
  {
    // A reef snorkel on a beach trip, with nothing on the list for the reef.
    id: "reef-packing",
    label: "Packing for a reef snorkel",
    brief: {
      scope: "packing",
      today: "2027-02-10",
      trip: {
        name: "Island week 2027",
      ...
      travelers: CREW,
      itinerary: [
        { item_date: "2027-03-15", title: "Reef snorkel from the boat", category: "excursion", location: "Tugboat Beach" },
        { item_date: "2027-03-17", title: "Walk the coast at Shete Boka", category: "excursion", location: "Shete Boka National Park" },
      ],
      packing: [
        { item: "swimsuit", assignee: "Nora" },
        { item: "swimsuit", assignee: "Theo" },
        { item: "swimsuit", assignee: "Ivy" },
        { item: "sun hats", assignee: "Shared" },
        { item: "sandals", assignee: "Shared" },
      ],
    },
    wants: /(reef[- ]safe|mineral sunscreen|water shoes|reef shoes|rash guard)/i,
    already: [/swimsuit/i, /sun hat/i],
  },
  {
    // Cool November evenings at a theme park, with only rain gear packed.
    id: "park-evenings",
    label: "Packing for cool park nights",
    brief: {
      scope: "packing",
      today: "2026-10-20",
      trip: {
      ...
      travelers: CREW,
      itinerary: [
        { item_date: "2026-11-23", title: "Park day until the fireworks", category: "activity", location: "Magic Kingdom" },
        { item_date: "2026-11-25", title: "Evening boat to the resort", category: "transport", location: "Seven Seas Lagoon" },
      ],
      packing: [
        { item: "ponchos", assignee: "Shared" },
        { item: "walking shoes", assignee: "Nora" },
        { item: "walking shoes", assignee: "Theo" },
        { item: "walking shoes", assignee: "Ivy" },
      ],
    },
    wants: /(layer|jacket|sweatshirt|hoodie|fleece|sweater|long sleeve)/i,
    already: [/poncho/i, /walking shoe/i],
  },
];
...
export const WALLET_CASES = [
  {
    ...
    // Neither program exists, so nothing about them can be looked up.
    madeUp: true,
  },
];
...
export const PRIOR_CASES = [
  ...
  },
  {
    ...
    truth: {},
    // "I like hiking" is a clear lean toward doing, which the production
    // instructions let through at medium confidence. Settling it is not a guess.
    allowed: { doing_or_seeing: "doing" },
  },
];
