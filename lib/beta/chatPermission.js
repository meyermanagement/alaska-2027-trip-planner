...
export function chatPermissionError(row, { minor = false, unavailable = false } = {}) {
  ...
  if (minor) return {
    error: "Ask Aly needs parent-managed access for your account. Ask your parent or guardian to open Family & pets, then Child access. Reloading will not turn chat on.",
