...
export const DATA_CATEGORIES = [
  ...
  },
  {
    ...
    what: "What you ask her, what she answers, and the trip context sent with the question \u2014 travelers, dates, bookings, access needs, and coverage in general terms.",
...
export const OPTIONAL_FEATURES = [
  ...
  },
  {
    ...
    detail: `Expiry dates, confirmation codes, and policy details pulled out of a file you choose, so you do not type them twice. The file itself is sent to ${AI_PROVIDER} to be read, and is not kept by them beyond their 30-day abuse window.`,
    without:
...
export const AI_DISCLOSURE = {
  sent: [
    ...
    "Insurance coverage in general terms: what is covered, the dates it runs, and whether anybody on the trip is not named on it",
  ],
  notSent: [
  ...
  terms: [
    `${AI_PROVIDER} is the only model provider we send to, and processing happens on its servers in the United States.`,
    ...
    "Turning Aly off stops the sending everywhere, including our overnight reminder and deadline jobs.",
  ],
  ...
  aside:
    "Reading a file is a separate step you take on purpose. Aly does not open your documents to answer an ordinary question.",
};
