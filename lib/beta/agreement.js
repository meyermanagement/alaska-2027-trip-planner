...
export const AI_DISCLOSURE = {
  ...
  terms: [
    `Aly's answers and forwarded booking email are handled by the ${ASSISTANT_PROVIDER}. Everything else goes to the ${READER_PROVIDER}, including web lookups, reading documents, fare alerts, and tips. If OpenAI is unavailable, the same work may go to Google instead.`,
