...
//
// Ask Aly's answers go to OpenAI. Web lookups, reading documents and forwarded
// mail, tips, and everything else go to Google. lib/agent/llm.js routes by the
// same split.
...
export const AI_DISCLOSURE = {
  ...
  terms: [
    `Aly's answers are written by the ${ASSISTANT_PROVIDER}. Everything else goes to the ${READER_PROVIDER}, including web lookups, reading documents and forwarded email, and tips. If OpenAI is unavailable, an answer may come from Google instead.`,
