...
// Both have to be reachable from outside the app, on a plain non-geofenced URL,
// for the store listings to point at them.
...
export const SUPPORT_EMAIL =
  process.env.NEXT_PUBLIC_SUPPORT_EMAIL || "support@alyeska.app";
