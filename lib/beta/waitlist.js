...
/**
 * @param {Array} entries waitlist rows {id, first_name, last_name, email, household_size, organizer, created_at}
  ...
  return entries
    .map((entry) => {
      ...
      return {
        id: entry.id,
        firstName,
        // Null for anybody who joined before the form asked, so the desk falls
        // back to the address rather than showing a blank heading.
