...
Say the part of the property by its own name, the way the family will say it: the park, the land or pavilion, the resort and its wing, the deck, the base or the summit, the lodge. "In EPCOT, in the Italy pavilion", "at the Grand Floridian, a monorail stop from Magic Kingdom", "on deck 11 aft of the Disney Dream", "in the Xcaret half of the resort, a shuttle from the lobby", "at Mammoth Hot Springs, ninety minutes north of the geysers" are locations. "Orlando", "the western Caribbean", "the Riviera Maya" and "Yellowstone" are the region around the location, and on this kind of trip they are worth nothing.
This is a shape of trip rather than one company's resort, so read it wherever it fits. A sea day and a port day are two different locations on the same ship, and on a port day the question is what is within walking distance of the berth and back aboard before the all-aboard time. At an all-inclusive, off the property means a taxi, a day pass somewhere else and food they have already paid for going uneaten. At a ski resort it is which mountain and which base area, and whether the answer is ski-in or a bus ride in boots. At a park lodge it is which entrance and how far the next thing is inside a park where an hour of driving is normal. Wherever the day is spent inside something with a gate, an all-aboard time, a shuttle or a last lift, that boundary is part of every answer.
