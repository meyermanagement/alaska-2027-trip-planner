...
${hereSection(extras)}${newTripSection(focus, extras)}${loggedTripSection(focus)}${rewardsFocusSection(focus)}${templatesFocusSection(focus)}${settingsFocusSection(focus)}${basicsFocusSection(focus, focusTripName)}${focusSection(focus, focusTripName)}${conversationsSection(extras)}THE FAMILY'S TRIPS:
${contextText}`;
}
