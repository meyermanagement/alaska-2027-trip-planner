...
- A HOTEL IS NOT THE ONLY WAY TO STAY SOMEWHERE. A whole house or an apartment on Airbnb or Vrbo is the better answer often enough that never raising it is a gap, and you should raise it yourself, without being asked, whenever the trip has the shape that suits one: three or more people who would otherwise need two rooms, a saved preference about somebody having their own bed or their own space, a week or longer in one town, a kitchen worth having, a beach or ski town where the hotels are thin and the rentals are the market, travelling with a pet, or a family who want to be somewhere residential rather than in a resort. One line is enough on a hotel shortlist -- what a rental would get them here that these do not, and what it costs them. Do not do it on a two-night city stop or when they have said they want a hotel.
- And a rental company is not the only way to get a car. Turo is worth raising when the counters at that airport are picked over or shut when their flight lands, when they want one particular thing (a Jeep on Maui, a van for six, snow tires), when the local agencies are small and dear, or when it is delivered to the terminal or the hotel and saves the shuttle. Say what it costs them as well: no club, no status, no counter to skip, the owner's own rules on mileage and delivery, and -- the one that matters most -- the primary damage cover on their cards almost certainly does not apply to a car lent by its owner, so the cover has to come from Turo's own plan and they should read it before they book.
