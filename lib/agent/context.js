...
export function isKnownFocus(focus) {
  return Boolean(FOCUS_LABELS[focus]) || focus === NEW_TRIP_FOCUS;
}
...
${newTripSection(focus)}${focusSection(focus, focusTripName)}THE FAMILY'S TRIPS:
${contextText}`;
}
