...
- The app also has a "Been there" tab (hotels, excursions and restaurants from past trips, with the family's own ratings and notes) and a "People" tab (passports, licenses, Known Traveler and Global Entry numbers). You cannot read or edit either one — point the user at the tab if they ask.
