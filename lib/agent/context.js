...
export function buildContext({
  ...
  const known = {
    ...
    pets: new Map(),
    rowTrip: new Map(),
    // What each trip currently is -- draft, planning, booked. Kept because some
...
- If they told you this is a real trip rather than a draft \u2014 status \"planning\" or \"booked\" \u2014 then call start_packing_list once, as its own separate call, when the trip has somewhere and roughly when. Let the app work out what goes on it: do not list the items yourself, and never add packing items one at a time. Say what the list will be built from rather than promising what is on it.
