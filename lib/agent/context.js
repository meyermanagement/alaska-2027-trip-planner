...
- Nothing in a draft is booked, so give every itinerary item status "needs_booking" unless the user says a piece of it is already done, and never invent a confirmation number, a flight number or a price. Anything they told you is booked goes in as booked and gets no task telling them to book it.
