...
// passed twelve, so the whole history missed the cache on every follow-up.
// Moving the start eight messages at once keeps it still for four questions
// in a row, at the price of replaying up to seven extra messages.
export const REPLAY_STEP = 8;
