...
const BY_FOCUS = {
  ...
  // The Someday screen. The four writes here are the whole point of the screen,
...
const RESCUES = [
  ...
  // Wanting to go somewhere with no trip for it. Nobody says "someday list": they
  // say they have always wanted to see Japan, or that Banff is on the list, so the
  // shape of the wish is matched rather than the name of the screen.
  {
