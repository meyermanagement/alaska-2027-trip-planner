...
// the same option, that the panel draws in a second row once one of the first
// row's chips has been tapped. That second row used to be generated on the fly
...
export const INTERVIEW_QUESTIONS = [
  {
    ...
    prompt: "How busy do you like being?",
    options: [
      {
        value: "packed",
        label: "Pack it in",
        ...
        more: [
          "Book the early slot so the day has room for a fourth thing.",
          "A long lunch is a stop we would rather skip.",
          "Two things before noon, two after.",
        ],
      },
      {
        value: "one_thing",
        label: "One thing a day, tops",
        ...
        more: [
          "Nothing booked before ten.",
          "Same neighborhood two days running is fine by us.",
          "If there is a second thing, it should be five minutes' walk from the first.",
        ],
      },
    ],
    otherReasons: [
  ...
  },
  {
    ...
    prompt: "Early bird, night owl, or somewhere in between?",
    ...
    options: [
      {
        ...
        more: [
          "Gear rental is fine; carrying our own is not.",
          "Half a day is the right length for the active thing.",
          "One of us sits out and that is not a problem.",
        ],
      },
      {
        value: "seeing",
        ...
        more: [
          "A bench or a cafe at the end of it.",
          "Shade matters more than the view does.",
          "We would rather see one thing properly than three quickly.",
        ],
      },
    ],
    otherReasons: [
  ...
  },
  {
    ...
    options: [
      {
        value: "hotel",
        label: "Somebody else makes the bed",
        short: "a hotel",
        ...
        more: [
          "Breakfast included, not billed.",
          "A pool we would actually swim in.",
          "Late checkout is worth asking for every time.",
        ],
      },
      {
        value: "small_inn",
        label: "Ten rooms and a cooked breakfast",
        ...
        more: [
          "Somebody at the desk who will book things for us.",
          "We will take a smaller room in a better building.",
          "No shared bathrooms.",
        ],
      },
      {
        value: "rental",
        label: "Somewhere with a kitchen",
        ...
        more: [
          "A real table to eat at, not a counter.",
      ...
      {
        value: "resort",
        label: "Never leave the property",
        short: "a resort",
        ...
        more: [
          ...
          "We will book excursions through the resort rather than arrange our own.",
        ],
      },
    ],
    otherReasons: [
    ...
    options: [
      {
        ...
        more: [
          "One driver, so the route has to be manageable alone.",
          "We would rather pay for the bigger car.",
      ...
      },
      {
        ...
        more: [
          "A hotel near the station, always.",
          "Seats reserved in advance, not turn-up-and-go.",
          "One bag each, because we are carrying them.",
        ],
      },
      {
        value: "walk",
        label: "Nobody, we walk",
        ...
        more: [
          "Flat, or we will feel it by day three.",
          "A taxi when it rains, and no guilt about it.",
          "Everything we need inside one neighborhood.",
        ],
      },
      {
        value: "driver",
        label: "Somebody else is",
        ...
        more: [
          "The same driver the whole trip if we can.",
  ...
  },
  {
    ...
    prompt: "What's dinner, on a good night?",
    ...
    options: [
      {
        ...
        more: [
          "One of us queues while the others walk.",
      ...
      {
        value: "quiet",
        label: "The place with the empty table",
        short: "a quiet table",
        detail:
      ...
      {
        value: "market",
        label: "A paper plate, standing up",
        ...
        more: [
          "Cash on us, because the good stalls will not take a card.",
          "One proper sit-down meal a day is plenty.",
          "We will eat whatever is being made that day.",
        ],
      },
      {
        value: "cook",
        ...
        more: [
          ...
          "Bring the coffee, or find it the first morning.",
        ],
      },
      {
        value: "familiar",
        ...
        // without them.
        needsKids: true,
        label: "Somewhere the kids will actually eat",
        ...
        more: [
          ...
          "We will order for them off the adult menu.",
        ],
      },
    ],
    otherReasons: [
  ...
  },
  {
    slot: "crowds",
    kind: "options",
    label: "Crowds, lines and noise",
    prompt: "There's a line. Now what?",
    options: [
      {
        value: "with",
        label: "Get in it",
        ...
        more: [
          "Buy the upgrade that gets us in sooner.",
          "One famous thing a day, and nothing else booked around it.",
          "We will queue in the rain.",
        ],
      },
      {
        value: "without",
        label: "Beat it",
        detail: "There at nine, same view, no crowd, and you eat lunch after.",
        ...
        more: [
          "Up at six if it means having it to ourselves.",
          "The second-most-famous thing, on purpose.",
          "Shoulder season over summer, every time.",
        ],
      },
    ],
    otherReasons: [
      ...
      "Worth the line on a one-time trip.",
    ],
  },
  {
    slot: "money",
    ...
    prompt: "Something has to give. What doesn't?",
  ...
  },
  {
    ...
    help: "Allergies, medications, mobility, altitude, seasickness, or a phobia like heights, small spaces, spiders, water or flying. Blank is a fine answer.",
  ...
  },
  {
    ...
    prompt: "What do you still bring up at dinner?",
    ...
    help: "Favorite moments from past trips, in your own words. One line each.",
    placeholder:
