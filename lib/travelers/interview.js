...
export const INTERVIEW_QUESTIONS = [
  ...
  },
  {
    ...
    help: "Add them one at a time, and fix or remove any of them before you finish. One is fine, none is fine, and these are yours: everybody else's go on their own file. I read them before every answer I write, so a real moment in your own words is worth more to me than a tidy list of places.",
    placeholder:
      "e.g. a slow dinner on a terrace in Rome, the morning we found tide pools in Maine.",
  },
];
