...
export const INTERVIEW_QUESTIONS = [
  ...
  },
  {
    ...
    prompt:
      "Three prompts, one box each. Your own favorite moments from past trips, in your own words.",
    help: "The kind of thing you would tell a friend about at dinner. One is fine, none is fine, and these are yours: everybody else's go on their own file. I read them before every answer I write, so a real moment in your own words is worth more to me than a tidy list of places.",
    // One prompt per box, because three identical blanks under one instruction
    // ask the same question three times and get one answer. A meal, a morning
    // and a place somebody would return to are three different memories, and
    // being asked for each of them separately is what makes the second and
    // third box worth filling in.
    //
    // The example lives in the placeholder rather than in a strip of chips
    // underneath: a specimen belongs in the box it is a specimen of, and it
    // cannot be mistaken for something to tap.
    rows: [
      {
        heading: "A meal you still talk about",
        placeholder: "e.g. the first bite of the pizza in Naples.",
      },
      {
        heading: "A morning that went right",
        placeholder: "e.g. the morning we found tide pools in Maine.",
      },
      {
        heading: "Somewhere you would go back to",
        placeholder: "e.g. the beach on Kauai, late in the day.",
      },
    ],
    extraRow: {
      heading: "Anything else worth remembering",
      placeholder: "e.g. the night the northern lights came out.",
    },
  },
];
