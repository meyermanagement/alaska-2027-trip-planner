...
export const INTERVIEW_QUESTIONS = [
    ...
    options: [
      ...
      },
      {
        ...
        reasons: [
          ...
          "Two tickets a day; the rest should be walking.",
  ...
  },
  {
    ...
    options: [
      ...
      },
      {
        ...
        reasons: [
          "Out the door by nine, back by four.",
      ...
      },
      {
        ...
        reasons: [
          "Dinner at nine is early for us.",
    ...
    options: [
      ...
      },
      {
        ...
        reasons: [
          ...
          "The good ones ask for a walk, not a workout.",
          "Somewhere to sit at the top.",
        ],
      },
    ],
    otherReasons: [
    ...
    options: [
      ...
      },
      {
        ...
        reasons: [
          ...
          "A real front desk, not a lockbox.",
        ],
      },
      {
        value: "resort",
  ...
  },
  {
    ...
    options: [
      {
        ...
        reasons: [
          ...
          "One splurge meal a trip; the rest simple.",
          "A tasting menu once a trip.",
        ],
      },
      {
        value: "quiet",
        ...
        reasons: [
          "An empty table, nobody in the way.",
    ...
    otherReasons: [
      "One splurge meal a trip; the rest simple.",
      "The one hard reservation before the flights.",
