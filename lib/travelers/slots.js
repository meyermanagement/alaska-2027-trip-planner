...
export const SLOTS = [
  {
    ...
    why: "Decides whether a day gets three things or one, whether I leave an afternoon empty on purpose, and how much I plan in advance rather than leaving to the morning.",
    fills:
