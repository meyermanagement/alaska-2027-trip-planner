 ...
 */
export function rehearsal(travelerId, { preferences = [], facts = [] } = {}) {
  ...
  const state = {
    ...
    // Deliberately empty rather than copied: a rehearsal is a rehearsal of this
    // conversation, and starting it mid-way through a real one makes the run
    // unreadable. What the person has already answered still arrives, through
    // the preferences and facts above.
    slots: [],
  };
  let n = 0;
