 ...
 *
 * These prompts are intentionally about the person -- work, hobbies, what they
 * read, landscapes and subjects that call to them, language, heritage, health,
 * why this trip matters. How you travel -- pace, food, early or late, where to
 * spend the money -- is asked by the interview, so it does not need to be
 * prompted here as well.
 */
export const ABOUT_ME_PROMPTS = [
  "what you do for work, and what you'd rather be doing",
  "the hobbies and interests that follow you on a trip",
  "what you read, watch or listen to",
  "landscapes and places that call to you \u2014 mountains, coast, desert, city",
  "history, architecture, art, sport, faith, music, food-as-culture",
  "languages you speak, or want to try",
  "where you grew up, and family or heritage worth knowing",
  "health notes, allergies, phobias or physical limits worth flagging",
  "a milestone or reason this trip is happening",
];

/** What sits in an empty box. Grey, so it must not look like an answer already given. */
export const ABOUT_ME_PLACEHOLDER =
  "Write it the way you would say it to a friend who was planning the trip for you: what you do, what you're into, the places and subjects that pull at you, and anything about you worth knowing before they start suggesting.";
