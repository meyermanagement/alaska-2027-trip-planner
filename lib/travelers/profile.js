...
/**
 * Short prompts that write into the same paragraph, one bite at a time.
 *
 * The nine-row textarea is honest but hard \u2014 a lot of people stare at it and
 * write two sentences. These four give somebody who cannot face a paragraph a
 * way in: two or three sentences per box, and Add to my paragraph appends them
 * to the main box with a blank line between. The paragraph is still the source
 * of truth; these are just funnels into it, so nothing downstream changes.
 */
