...
export const ABOUT_ME_MICRO_PROMPTS = [
  {
    ...
    placeholder:
      "Hobbies, sports, live shows. Broadway with my wife, jogging at sunrise, fishing all summer.",
  },
  {
    key: "into",
    label: "What you're interested in",
    placeholder:
      "Subjects, places, teams. The Civil War, the Cardinals, mountain towns, a country I want to see.",
  },
  {
    key: "standards",
    label: "What you're particular about",
    placeholder:
      "The room has to be spotless. Nothing under four and a half stars. I don't drink. Aisle seat.",
  },
  {
    key: "skip",
    label: "What you'd rather skip",
    placeholder:
      "No cruises. Not a group tour. Crowds wear me out. Nothing that starts before seven.",
  },
  {
    key: "else",
    label: "What you're like",
    placeholder:
      "Up at five, done by nine. Happier with a plan. Quiet in a crowd. Work, health, faith, family.",
  },
];
...
export const ABOUT_ME_CHIP_GROUPS = [
  ...
  {
    key: "standards",
    label: "Rooms, places and seats",
    prefix: "I care about",
    target: "standards",
    items: [
      "a spotless room",
      "top-rated places only",
  ...
  },
  {
    ...
    items: [
      ...
      "like craft beer",
      "like a bourbon after dinner",
      "would skip a winery tour",
  ...
  {
    key: "temperament",
    label: "Mornings, energy, temperament",
    prefix: "I'm",
    target: "else",
    items: [
      "an early riser",
...
export const ABOUT_ME_PLACEHOLDER =
  "Write it the way you'd say it to a friend planning a trip for you. What you love doing (Broadway, jogging, fishing, an hour in a bookshop), what you're particular about (a spotless room, top-rated places only, whether you drink), and what you'd rather skip (cruises, buffets, hot weather). A paragraph is plenty.";
