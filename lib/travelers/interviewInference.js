...
const RULES = [
  ...
  // "We book the hard reservation before we book the flights" is offered under
  // both The local place with the line and The meals, identically.
  {
  ...
  // "A tasting menu once a trip is our floor" against The meals' own "One
  // tasting menu per trip is our floor".
  {
  ...
  // "A driver who speaks the language is worth twice the price" against The
  // experiences' "A guide who speaks the language is worth twice the price".
  {
  ...
  // against The experiences' "A private guide over a group tour, every time".
  ...
  // "A timed ticket is worth booking six months out" against The experiences'
  ...
  // "Free hotel parking is worth paying up for on the room" does the same from
  ...
  // "An empty city at dawn is a wasted city; we want it full" is the queue
  ...
  // "An early start means we skip the parking problem entirely" -- only
  ...
  // "One splurge meal per trip; the rest can be simple" puts the splurge on a
  ...
  // "A guided activity is worth it if the guide is what makes it possible" is
  ...
  // "Two paid tickets a day is our cap; the rest should be walking" makes
  ...
  // "A hotel bar we would actually use is worth paying up for" is about the
  ...
  // "The empty version of a famous place is worth losing sleep for" is about
