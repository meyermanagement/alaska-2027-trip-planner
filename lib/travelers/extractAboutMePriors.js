...
// set is picked from or ordered. The text-shaped "limits" question is
// free-form (allergies, phobias, mobility) and the moments question is a list
// of memories; neither maps to a chosen value.
//
