...
//
// Uses the same Gemini text-model ladder as document extraction -- 3.6 Flash
// first, 3.5 Flash-Lite as fallback, both told to think only a little -- so no
// new key or vendor to configure. Pro used to lead this ladder and, with no
...
// Reviewed 2026-09-25 against the model check and left as it is: one short call
// per paragraph, rare, and nothing measured beat 3.6 Flash at low thinking by
// enough to be worth a change. The check's "About-you paragraph" type now tests it.
const DEFAULT_TEXT_MODELS = ["gemini-3.6-flash", "gemini-3.5-flash-lite"];
// Both models on the default ladder accept it; a model that does not is a 400,
