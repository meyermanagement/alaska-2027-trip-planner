 ...
 * (lib/documents), tickets and confirmations filed against the trip they
 * belong to, calendar export (lib/calendar), per-person limits (lib/travelers/limits.js), pets travelling
...
export const ALY_INDEX = [
  {
    ...
    items: [
      ...
      "Tickets and confirmations filed by trip",
