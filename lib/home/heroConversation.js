 ...
 * hold. The second asks what there is to know about tomorrow rather than what
 * is on it, which is the honest version of the question and the one the answer
 * actually earns: the plan for the morning comes back with what to carry, tied
 * to the specific people going and the specific boat.
 *
...
export const HERO_CONVERSATION = [
  ...
  },
  {
    ...
    tail: "It is on the packing list for Wednesday morning, so nobody is remembering it at six in the dark.",
  },
];
