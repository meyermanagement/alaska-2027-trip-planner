    ...
    places: [
      {
        ...
        rating: "4.6",
        count: "1,204",
        why: "Tables outside by the water and no reservation, so you can be eating by half six and Mia is in bed on time. She eats the tacos, and shellfish is cooked on its own grill at the back, away from Dani's plate.",
        lead: true,
      },
      {
